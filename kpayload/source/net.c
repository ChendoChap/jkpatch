...
// specific to 4.74, may change in other updates
...
void net_disable_copy_checks() {
	...
	uint16_t *copyin1 = (uint16_t *)(kernbase + 0x149F68);
	uint16_t *copyin2 = (uint16_t *)(kernbase + 0x149F77);

	uint16_t *copyout1 = (uint16_t *)(kernbase + 0x149E7B);
	uint16_t *copyout2 = (uint16_t *)(kernbase + 0x149E83);
	uint16_t *copyout3 = (uint16_t *)(kernbase + 0x149E92);
...
int net_socket(int domain, int type, int protocol) {
	...
	int (*sys_socket)(struct thread * td, struct sys_socket_args * uap) = (void *)(kernbase + 0x3EBA90);
...
int net_bind(int sockfd, struct sockaddr *addr, int addrlen) {
	...
	int (*sys_bind)(struct thread * td, struct sys_bind_args * uap) = (void *)(kernbase + 0x3EC3C0);
...
int net_listen(int sockfd, int backlog) {
	...
	int (*sys_listen)(struct thread * td, struct sys_listen_args * uap) = (void *)(kernbase + 0x3EC5D0);
...
int net_accept(int sockfd, struct sockaddr *addr, int *addrlen) {
	...
	int (*sys_accept)(struct thread * td, struct sys_accept_args * uap) = (void *)(kernbase + 0x3ECD30);
...
int net_recv(int fd, void *buf, uint64_t len) {
	...
	int (*sys_read)(struct thread * td, struct sys_read_args * uap) = (void *)(kernbase + 0x5E230);
...
int net_send(int fd, const void *buf, uint64_t len) {
	...
	int (*sys_write)(struct thread * td, struct sys_write_args * uap) = (void *)(kernbase + 0x5E780);
...
int net_setsockopt(int s, int level, int optname, const void *optval, uint32_t optlen) {
	...
	int (*sys_setsockopt)(struct thread * td, struct sys_setsockopt_args * uap) = (void *)(kernbase + 0x3EE170);
...
int net_close(int fd) {
	...
	int (*sys_close)(struct thread * td, struct sys_close_args * uap) = (void *)(kernbase + 0x42BA70);
